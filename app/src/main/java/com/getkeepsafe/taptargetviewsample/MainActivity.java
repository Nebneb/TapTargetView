...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Rect droidTarget = new Rect(0, 0, droid.getIntrinsicWidth() * 3 / 2, droid.getIntrinsicHeight() * 3 / 2);
        // Using deprecated methods makes you look way cool
        droidTarget.offset(display.getWidth() * 2 / 3, display.getHeight() * 2 / 3);

...
public class TapTarget {
    ...
    int topTitleTextSizePx(Context context) {
        return dimenOrSize(context, topTitleTextSize, -1);
    }
    ...
    public TapTarget topTitle(CharSequence secondaryTitle, @Nullable  Integer topTitleIcon) {
        this.topTitle = secondaryTitle;
        if (topTitleIcon != null) this.topTitleIcon = topTitleIcon;
        return this;
    }
